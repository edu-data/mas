...
| 보고서 | 설명 |
|--------|------|
| [🤖 MAS 플랫폼 홈페이지](https://edu-data.github.io/mas/docs/mas-index.html) | 멀티 에이전트 수업 분석 플랫폼 소개 |
| [📊 MAS 분석 대시보드](https://edu-data.github.io/mas/docs/mas-dashboard.html) | 8-에이전트 파이프라인 18개 영상 분석 결과 |
...
**2025-12-09 수업 시연 데이터** (18개 영상) - RAG 연동 Gemini 분석

| 통계 | 결과 |
|------|------|
| 📊 평균 점수 | **77.1점** / 100점 |
| 🏆 최고 점수 | **84점** (20251209_110545.mp4) |
| 📉 최저 점수 | **68점** (20251209_100926.mp4) |
| ⏱️ 총 소요 시간 | **86.3분** (18개 영상) |
| ✅ 성공률 | **100%** |

**등급 분포**: A등급 7개 (39%) / B등급 9개 (50%) / C등급 2개 (11%)

[👉 대시보드 보기](https://edu-data.github.io/GAIM_Lab/batch_dashboard.html) | [👉 최고 점수 리포트](https://edu-data.github.io/GAIM_Lab/best_report_110545.html)
